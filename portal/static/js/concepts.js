...
output:
  use_llm_guard: true     # 用 Presidio NER 检测姓名 / 地址等自然语言 PII`,
    cost: [
      ...
      { ic: "📈", t: "PII 召回 53.5% → ~80%", d: "正则档输出 PII 召回 53.5%,开 NER 后提到约 80%。" },
    ],
  };
  ...
  PS.view("guide", {
    ...
    blockNer() {
      ...
      <section class="gd-block" id="gd-ner">
        ...
        <div class="callout ok" style="margin-top:14px">✅ <b>结论:</b>对姓名 / 地址泄露敏感的场景(对外客服、RAG 检索外发)值得开;延迟 / 体积敏感、PII 以结构化为主的场景,正则档已覆盖 53.5%,可不开。</div>
      </section>`;
    },
  });
})();
